...
$(document).ready(function() {
    ...
    var headerHTML = '';
    var loadingHTML = '';
    headerHTML += '<a href="https://twitter.com/" target="_blank"><img src="twitter/twitter-bird-light.png" width="34" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
    ...
    loadingHTML += '<div id="loading-container"><img src="twitter/ajax-loader.gif" width="16" height="16" alt="tweet loader" /></div>';

    $('#twitter-feed').html(headerHTML + loadingHTML);

    $.getJSON('include/get_tweets.php',
            function(feeds) {
                //alert(feeds);
                var feedHTML = '';
