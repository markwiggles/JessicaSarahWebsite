...
function getTwitter () {
    ...
    exception = "";
    var displaylimit = 10;
    var twitterprofile = "jsarahmusic";
    var screenname = "Jessica Sarah";
    ...
    var headerHTML = '';
    var loadingHTML = '';
    headerHTML += '<a href="https://twitter.com/" target="_blank"><img src="/assets/twitter-bird-light.png" width="34" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
    ...
    loadingHTML += '<div id="loading-container"><img src="assets/ajax-loader.gif" width="16" height="16" alt="tweet loader" /></div>';

    $('#twitter-feed').html(headerHTML + loadingHTML);

    $.getJSON('follow/get_twitter_data',
        function (result) {

            var feeds = $.parseJSON(result);
